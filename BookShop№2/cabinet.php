...
<main role="main" class="container">
  <?php
    ...
    $userid = $_COOKIE['id'];
    $query = mysqli_query($connection, "SELECT * FROM `users_info` WHERE `user_id` = '$userid' ");
...
<div class="btn-group">
    <a href="cabinet.php" class="btn btn-secondary active">
        Профиль
    </a>
  ...
  <div class="row no-gutters">
    ...
    <div class="col-md-8">
      <div class="card-body">
        ...
        <p class="card-text"><small class="text-muted">Книг куплено: <?php echo $userinfo['bookbought']; ?> </small></p>
      </div>
    </div>
  </div>
</div>
<div class="card bg-dark text-white">
  <img src="Pict/books.jpg" class="card-img" alt="...">
  <div class="card-img-overlay" style="text-align: right;">
    <h5 class="card-title" style="color: #FFE4C4;">Персональная информация</h5>
    <p class="card-text" style="color: #FFF8DC;">Мобильный телефон: <?php echo $userinfo['phonenumber']; ?></p>
