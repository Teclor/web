...
<main role="main" class="container">
  ...
  <section class="jumbotron text-center">
    <div class="container">
      ...
      <p>
        <a href="sale.php" style="width: 210px" class="btn btn-primary my-2">Акции и скидки</a>
        <a href="distribution_points.php" style="width: 210px" class="btn btn-secondary my-2">Информация о доставке</a>
      </p>
    ...
    <div class="album py-5 bg-light" style="height: 100px; color: cadetblue;">
